...
export async function seedPlatform(prisma: PrismaClient) {
  await prisma.platformPlan.createMany({
    data: [
      {
        name: "STARTER", label: "Starter", monthlyFee: 2500, maxRooms: 10, maxResorts: 1, maxStaff: 2,
        trialDays: 14, audience: "RESORT", sortOrder: 1, active: true, highlight: false,
        blurb: "For small resorts getting off spreadsheets",
        features: ["discounts"],
      },
      {
        name: "GROWTH", label: "Growth", monthlyFee: 5000, maxRooms: 40, maxResorts: 2, maxStaff: 8,
      ...
      {
        name: "CHAIN", label: "Chain", monthlyFee: 12000, maxRooms: 10000, maxResorts: 10, maxStaff: 60,
      ...
      },
      {
        ...
        name: "PRO", label: "Pro (retired)", monthlyFee: 8000, maxRooms: 100, maxResorts: 4, maxStaff: 20,
      ...
      {
        name: "AGENCY_BASIC", label: "Agency Basic", monthlyFee: 1200, maxRooms: 0, maxResorts: 0, maxStaff: 3,
      ...
      {
        name: "AGENCY_PRO", label: "Agency Pro", monthlyFee: 3500, maxRooms: 0, maxResorts: 0, maxStaff: 15,
