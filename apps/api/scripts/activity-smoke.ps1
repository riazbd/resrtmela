...
$free = ($av | Where-Object { $_.busyNights.Count -eq 0 })[0]
...
# 6) cancelling the room booking releases staff's 3 seats -> 5
...
Write-Host ("6. booking cancelled -> remaining=" + $released.remaining + " (expect 5 - staff seats released)")
